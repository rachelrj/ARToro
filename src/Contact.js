                ...
                {this.state.hasSent && !this.state.hasError &&
                    ...
                    <div id="contact-content">
                        <p>I appreciate that you’ve taken the time to write me. I will get back to you as soon as possible, usually within a few days. I will respond to you through my business gmail using the email address you just provided.</p>
                         <p>While you are waiting ever so patiently for my reply, take a look at my <a className="tiffany" href="https://www.instagram.com/toro4art/" target="_blank" rel="noreferrer">Instagram page</a> to see more examples I have done for others in the past. I plan to share some fun highlights of my teaching very soon!</p>
                    </div>
                    </>
                }
                {this.state.hasError &&
